...
export const translations: Record<Language, any> = {
  ja: {
    ...
    emotional: '感情',
    intellectual: '知性',
    biorhythmDesc: '生年月日から算出される3つのリズムで、今日のコンディションを確認できます。',
    highCondition: '好調',
    lowCondition: '不調',
    neutralCondition: '普通',
    weeklyLife: '残り寿命 (週初め)',
  ...
  en: {
    ...
    biorhythmDesc: 'Check your daily condition based on three cycles calculated from your birth date.',
    highCondition: 'High',
    lowCondition: 'Low',
  ...
  es: {
    ...
    premiumSubtitle: 'Funciones especiales para enriquecer tu vida',
  ...
  fr: {
    ...
    locked: 'Verrouillé',
    premiumTitle: 'Plan Premium',
    premiumSubtitle: 'Fonctions spéciales pour enrichir votre vie',
    premiumFeature1: 'Débloquer des catégories de citations spécialisées',
    premiumFeature2: 'Analyse quotidienne du biorythme',
    premiumFeature3: 'Débloquer la fonction de notes de la liste de souhaits',
    premiumFeature4: 'Conseils IA pour vos objectifs (Quotidien)',
    purchase: 'Acheter',
